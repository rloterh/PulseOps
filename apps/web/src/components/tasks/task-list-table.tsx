...
export function TaskListTable({ items }: { items: TaskListItem[] }) {
  return (
      ...
      <div className="grid gap-3 p-4 lg:hidden">
        {items.map((item) => (
          ...
          >
            ...
            <p className="mt-4 text-sm text-white/52">{item.assigneeName ?? 'Unassigned'}</p>
